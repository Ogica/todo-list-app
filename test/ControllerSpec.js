...
describe('controller', function () {
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo = [{id: 42, title: 'my todo', completed: false},{id:3, title:"next todo",completed:false}];
			setUpModel(todo)
			subject.setView('')
		...
		it('should update the view', function () {
			// TODO: write test
			var todo = {id: 50, title: 'my todo', completed: true};
				setUpModel([todo]);
				subject.setView('');
				var parameter = {	completed: false};
				view.trigger('toggleAll', parameter);
				expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 50, completed: false});
			});
	});
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			...
			setUpModel([]);
			subject.setView('');
			var newTitle = 'Whatever todo';
			view.trigger('newTodo', newTitle);
			expect(model.create).toHaveBeenCalledWith(newTitle, jasmine.any(Function));
		});
